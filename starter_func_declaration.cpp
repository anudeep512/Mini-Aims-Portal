// In this file, we are going to define all the Operations which we use Starter Function class
// In this file we are going to define functions which are called as starter functions where our class object is created,
// And here we choose the required mode which want to enter into.
...
// When we choose the ADMIN mode in the main function, we end up at this function from which our program proceeds based on choice of modes
...
// When we choose the TEACHER mode in the main function, we end up at this function from which our program proceeds based on choice of modes
...
// When we choose the STUDENT mode in the main function, we end up at this function from which our program proceeds based on choice of modes
